...
function Main() {
    ...
    return (
        <>
            <Bg1 c1="bg1 wave" c2="caption firstcaption" c3="firstbox" c4="top" text="Software Engineer" animate/>
            ...
            <Bg1 c1="bg1" c2="caption" c3="box lastBox" text={<Link to={'/projects'} onClick={scrolltoTop} className="projects"><span className="largeC">Checkout my projects</span><span className="smallC">My projects</span></Link>} />
        </>
    )
}
