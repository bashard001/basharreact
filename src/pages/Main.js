...
<div>
  ...
  <Bg1 c1="bg1" c2="caption" c3="box lastBox" text={<Link to={'/projects'} className="projects"><span className="largeC">Checkout my projects</span><span className="smallC">My projects</span></Link>}/>
